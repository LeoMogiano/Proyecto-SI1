...
<form method="post" action="{{route('servicios.update',$servicio)}}">
    ...
    <h5>Descripción:</h5>
    <input type="text"  name="descripción" value="{{$servicio->descripción}}" class="focus border-primary  form-control">
    </div>
    
    <div class="form-group col-md-3" >
        <h5>Precio:</h5>
        <input type="text"  name="precio" value="{{$servicio->precio}}" class="focus border-primary  form-control">
