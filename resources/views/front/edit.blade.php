            ...
            <div class="row">
                ...
                <div class="navbar-collapse collapse">
                    <ul class="nav navbar-nav">
                        ...
                        <li class="active"><a href="{{ route('front.create') }}">Servicio</a></li>
        ...
        @foreach ($productos as $producto)
            <div class="card1">
                ...
                <div class="title1" style="display: flex; justify-content: center">
                    <input type="checkbox" style="padding-right: rem" value="{{$producto->id}}" name="servicio[]"class="form-check-input"><h1 style="padding-left: 0.65rem" class="leo">  {{ $producto->nombre }}</h1>   
                </div>
                @foreach ($modelos as $modelo)
                @if ($producto->Id_modelo==$modelo->id)
                <p class="card-text" style="display: flex; justify-content: center"> <b>Modelo :</b>{{ $modelo->nombre }}</p>
                @endif
                @endforeach
                <p class="card-text" style="display: flex; justify-content: center"> <b>Bs</b>{{ $producto->precio }}</p>
                <div class="des1">

                    <p class="card-text"> <b>Cantidad :</b></p>
                    <input type="text" name="cantidad" style="width: 40%; margin-left: auto;margin-right: auto" class="focus border-primary  form-control" required>
                   {{--  <br>
                    <button class="btn btn-primary" type="submit">Añadir a Carrito</button> --}}
                    <br>
                    <br>
